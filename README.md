...
#### 동민
- 이번 프로젝트에서 프론트엔드 UI 배치, 백엔드 기능 확장 및 인증 시스템 보완을 담당하였습니다. 보안을 비롯한 3차때 아쉬웠던 부분들을 상당 수 보완할 수 있어만족스러운 프로젝트였으며, 팀원들도 맡은 바 역할을 잘 수행하고 열의를 가지고 프로젝트에 임했기에 완성도를 높일 수 있었습니다.
