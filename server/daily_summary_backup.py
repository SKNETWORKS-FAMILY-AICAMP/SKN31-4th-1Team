# daily_summary_backup.py
#
# 2026-08-06, daily_summary.py의 "안전 직결 사건" concern_note 어투 수정 직전 백업.
# 팀원이 작성한 버전(체크인 필드 지원 + 역방향 tone 검증 추가된 상태)을 그대로 보존.
# 수정 사유/내용: mds/daily_summary_concern_note_fix.md 참고.
...
FEW_SHOT_EXAMPLES = [
    ...
    },
    {
        ...
        "content": (
            ...
            '"tone": "observe", '
            '"concern_note": "가스불을 안 끄고 나온 일이 있어 안전 관련으로 가볍게 지켜볼 만합니다. 다른 특별한 일은 없다고 하셨습니다.", '
