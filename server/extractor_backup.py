...
LLM ① 추출기.
사용자 발화 한 줄을 받아 명시적으로 언급된 정보만 JSON으로 추출한다.
...
if __name__ == "__main__":
    # 간단 동작 확인용. 정식 검증은 modules/tests/test_extractor.py 사용.
    sample = "어머니가 요즘 같은 말을 계속 반복하세요"
    print(f"입력: {sample}")
    print(f"출력: {extractor_node(sample)}")
